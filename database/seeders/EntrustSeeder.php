...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $customer = User::create(['first_name' => 'Ahmed', 'last_name' => 'Zuhri', 'username' => 'ahmed_zuhri', 'email' => 'ahmadj.abuzuhri@gmail.com', 'email_verified_at' => now(), 'mobile' => '966500000002', 'password' => bcrypt('123123123'), 'status' => 1, 'remember_token' => Str::random(10)]);
